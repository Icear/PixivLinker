...
class PUser implements PixivUser{
    ...
    @Override
    public PMember[] getConcernedList() throws IOException {
        //登陆身份下查看自己的关注列表，公开关注
        List<PMember> pMembers = new ArrayList<>();

        /*获得公开关注的用户*/
        getConcernedList(pMembers,true);
        /*获得隐藏关注的用户*/
        getConcernedList(pMembers,false);
     ...
     */
    private void getConcernedList(List<PMember> pMembers,boolean isShowedPartion) throws IOException {
     ...
     */
    private void parsePMemberFromHtml(List<PMember> pMembers,String html){
